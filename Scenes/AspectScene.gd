...
onready var tracking_settings = $"VBoxContainer/Content/MarginContainer/TrackingSettings"
...
func receive_navigation(navigation_data): 
	...
	if tracking_settings != null: tracking_settings.set_tracking_data(aspect_data.tracking)
